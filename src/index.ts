...
async function main(): Promise<void> {
  ...
  // Registry prefers the writable cache file, falls back to the packaged snapshot,
  // and kicks a background stale-while-revalidate refresh when the data is stale.
  const registry = new RegistryLoader(undefined, { cacheManager, analogApi });
